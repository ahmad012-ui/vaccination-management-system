...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'parent') {
    header("Location: /vaccination-management-system/login.php");
    exit;
}
        ...
        <div class="row gx-0 align-items-center" style="height: 45px;">
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <a href="#" class="btn btn-light btn-square border rounded-circle nav-fill me-0">
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="login.php" class="btn rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0" 
                   style="background-color:rgb(0, 204, 255);">Book Appointment</a>
                <a href="login.php" class="fa-solid fa-circle-user px-1 flex-wrap" 
                   style="color:rgb(0, 204, 255);font-size: 32px; margin-left: 20px;"></a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn-square btn btn-primary text-white rounded-circle mx-1" href="">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="btn-square btn btn-primary text-white rounded-circle mx-1" href="">
                                <i class="fab fa-twitter"></i>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-md-6 text-center text-md-start mb-md-0">
                    <span class="text-white">
                        <a href="#"><i class="fas fa-copyright text-light me-2"></i>Your Site Name</a>, All right reserved.
                    </span>
                </div>
