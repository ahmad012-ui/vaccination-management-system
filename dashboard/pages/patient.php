              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    ...
                    <tbody>
                    <?php
                      $user_query = "SELECT user_id, name, email, role, created_at FROM users";
                    ...
                    <?php while ($row = mysqli_fetch_assoc($user_result)) { ?>
                      ...
                      <td>
                        ...
                        <a href="edit_user.php?id=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                      </td>
                      </tr>
                    <?php } ?>
                  </tbody>
