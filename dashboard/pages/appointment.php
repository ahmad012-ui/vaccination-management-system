  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../pages/patient.html">
            <i class="material-symbols-rounded opacity-5">child_care</i>
            <span class="nav-link-text ms-1">Patient</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="../pages/vaccine.html">
        ...
        <li class="nav-item">
          <a class="nav-link  active bg-gradient-dark  text-white" href="../pages/appointment.html">
          ...
          <div class="col-12">
            <div class="card mb-4">
              <div class="card-header pb-0">
                <h6 class="text-capitalize">Hospital Inventory</h6>
              </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Available
                          Vaccines
                        </th>
                      ...
                      <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="text-sm mb-0">' . htmlspecialchars($row['location']) . '</p>
                            </td>
                            <td>
                              <span class="badge bg-gradient-success text-white text-xs">
                                ' . htmlspecialchars($row['available_vaccines']) . '
                              </span>
                            </td>
                            <td class="align-middle text-center">
                              <a href="edit-hospital.php?id=' . $row['id'] . '" class="btn btn-sm btn-info me-2">Edit</a>
                              <a href="delete-hospital.php?id=' . $row['id'] . '" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                          </tr>';
                        }
                      ?>
