  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark  text-white" href="../pages/vaccine.php">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Hospital Information</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php
                                $hospitalResult = mysqli_query($conn, "SELECT * FROM hospitals");
                                while ($hospital = mysqli_fetch_assoc($hospitalResult)) {
                                  echo "
                                  <tr>
                                    <td><p class='text-sm mb-0'>{$hospital['name']}</p></td>
                                    <td><p class='text-sm mb-0'>{$hospital['address']}</p></td>
                                    <td><p class='text-sm mb-0'>{$hospital['contact']}</p></td>
                                    <td><p class='text-sm mb-0'>{$hospital['status']}</p></td>
                                    <td>
                                      <a href='edit-hospital.php?id={$hospital['hospital_id']}' class='text-xs text-info font-weight-bold'>Edit</a> |
                                      <a href='delete-hospital.php?id={$hospital['hospital_id']}' class='text-xs text-danger font-weight-bold' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                                    </td>
                                  </tr>
                                  ";
                                }
              ...
              <div class="card-body px-0 pb-2">
                <div class="table-responsive p-0">
                  ...
                  <tbody>
                    ...
                    SELECT name AS hospital_name, vaccine_name, quantity, availability
                    FROM hospitals
                    ");
                    ...
                    $status = $row['availability'] === 'Available' ? 'Available' : 'Unavailable';
                    $badge = $row['availability'] === 'Available' ? 'bg-gradient-success' : 'bg-gradient-danger';
